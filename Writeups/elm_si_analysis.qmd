...
model_data <- 
  readRDS("Data/01_Processed/SI_model_data.rds") |> 
...
si_mdl <- wrap_diagnose(brm(resp_yes ~ tune + (1+tune|subj_id) + (1+tune|item),
                       data = model_data,
...
# ggview::ggview(avg_si_plot, width = 5, height = 5)
